      ...
      <section id="pricing" style={{ padding: '6rem 2rem', maxWidth: 1040, margin: '0 auto' }}>
        ...
        <div className="grid-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.25rem' }}>
          {[
            ...
            { name: 'Agency', price: '$49', plan: 'agency', features: ['Everything in Pro', '10 Team Members', 'Multi-client Dashboard', 'API Access', 'Custom Branding'], cta: 'Start Agency', popular: false },
